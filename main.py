...
def run_analysis1(number_of_runs):
    ...
    unified_query = And(e1.constraints, e2.constraints,
                        ...
                        assert_initial_db_eq(e1, e2), assert_any_final_db_neq(e1, e2))
    ...
    for i in range(number_of_runs):
        ...
        if unified_model:
            ...
            for obj in e1.object_map.keys():
                ...
                print(str(obj) + ': [init=%s]  [S_f=%s]  [W_f=%s]      ' %
                      (o_i, o1, o2))
        else:
            print('no model exists')
# introducing multiple objects
def run_analysis2(number_of_runs):
    ...
    for i in range(number_of_runs):
        ...
        if unified_model:
            ...
            print('no model exists')
# swap example
def run_analysis3(number_of_runs):
    ...
    for i in range(number_of_runs):
        ...
        if unified_model:
            ...
            for obj in e1.object_map.keys():
                ...
                o2 = unified_model[e2.object_map[obj][final_index]]
                o_i = unified_model[e1.object_map[obj][0]]
                #om = unified_model[e1.object_map[obj][4]]
                #nom = unified_model[e2.object_map[obj][5]]
                print (str(obj) + ': [init=%s]  [S_f=%s]  [W_f=%s]      ' %
                       (o_i, o1 , o2))
        else:
            print('no model exists')

# example with multiple commands in the conditional
def run_analysis4(number_of_runs):
    pass
